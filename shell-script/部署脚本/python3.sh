...
yum install wget -y zlib-devel bzip2-devel openssl-devel ncurses-devel sqlite-devel  # 安装python3依赖库
...
./configure  --prefix=/home/luyanjie/python3_5  # 指定编译安装位置
make && make install  # 编译安装

ln -s /root/python3_5/bin/python /usr/bin/  # 创建python3软链接
